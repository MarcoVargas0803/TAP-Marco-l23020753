...
P3 = ct.CTkLabel(f3, text="Genero: ", text_color="Red", anchor="w")
...
radio3_1 = ct.CTkRadioButton(f3, text="Masculino", variable=radio_var, value="p1")
radio3_2 = ct.CTkRadioButton(f3, text="Femenino", variable=radio_var, value="p2")

checkbox4_1 = ct.CTkCheckBox(f4, text="Deportes", variable=check_var4, command=checkbox_event)
checkbox4_2 = ct.CTkCheckBox(f4, text="Artes", variable=check_var4, command=checkbox_event)
checkbox4_3 = ct.CTkCheckBox(f4, text="Entretenimiento", variable=check_var4, command=checkbox_event)
...
#Submit
def submit():
	print(f'Nombre: {entrada_nombre.get()}')
    print(f'Apellido: {entrada_nombre.get()}')
